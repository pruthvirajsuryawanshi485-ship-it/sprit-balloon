...
class SpiritBalloonGame:
    ...
    def restart(self):
        ...
        self.paused = False
        self.last_spawn = time.time()
        self.canvas.delete("game_over", "level_notice", "pause_overlay")
    ...
    def update_visuals(self):
        ...
        self.visual_frame += 1
        pulse = 1 + math.sin(self.visual_frame / 12) * 5
        inner_pulse = 1 + math.sin(self.visual_frame / 10) * 3
        ...
        self.canvas.coords(
            ...
            BALLOON_X - 36 - inner_pulse,
            BALLOON_Y - 36 - inner_pulse,
            BALLOON_X + 36 + inner_pulse,
            BALLOON_Y + 36 + inner_pulse,
        )

...
class SpiritBalloonGame:
    ...
    def draw_balloon(self, x, y, color="#f8f1ff", glow=False):
        if glow:
            self.canvas.create_oval(x - 42, y - 42, x + 42, y + 42, fill="#234f63", outline="", tags="story")
        self.canvas.create_line(x, y + 22, x, y + 78, fill="#f7d6bd", width=2, tags="story")
        self.canvas.create_oval(x - 24, y - 30, x + 24, y + 24, fill=color, outline="#ffffff", width=3, tags="story")
        self.canvas.create_oval(x - 9, y - 16, x + 2, y - 5, fill="#ffffff", outline="", tags="story")
